...
import { setAlignment, getActiveAlignment, AlignValue } from './alignment-command';
...
export { setAlignment, getActiveAlignment } from './alignment-command';
export type { AlignValue } from './alignment-command';

---
"@inkstream/editor-core": patch
"@inkstream/eslint-config": patch
"@inkstream/image": patch
"@inkstream/pm": patch
"@inkstream/react-editor": patch
"@inkstream/starter-kit": patch
---

## `@inkstream/editor-core` — headless editor core & framework-agnostic APIs
...
*Svelte* — readable stores satisfying Svelte's `Readable<T>` contract:
```ts
...
*Vue 3* — bring-your-own-ref composable factory:
```ts
...
```ts
import { mountEditor, bindToolbarState, onContentChange } from '@inkstream/editor-core';
